                    ...
                    <v-tabs-window-item value="偏好设置">
                        <v-radio-group v-model="radios" @update:modelValue="radiosChange">
                            <v-card class="d-flex align-center pa-5 ga-5" flat>
                                <v-card class="d-flex flex-column align-center justify-center" width="300" hover variant="outlined" theme="light">
                                    <v-card
    class="mx-auto"
    max-width="344"
    hover
  >
    ...
    <v-card-text>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                ...
                                <v-card class="d-flex flex-column align-center justify-center" width="300" hover variant="outlined" theme='dark'>
                                    <v-card
    class="mx-auto"
    max-width="344"
    hover
